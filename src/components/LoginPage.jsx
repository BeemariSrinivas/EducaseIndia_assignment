    ...
    return(
        <div className="h-screen flex justify-center items-center">
            <div className="border flex flex-col justify-start h-screen w-96 p-6 font-medium ">
                ...
                <label className="text-[#7030dfdb] relative translate-x-3.5 -translate-y-13.5 z-10 w-fit pl-1 text-sm pr-3 bg-white" htmlFor="emailAddress">Email Address</label>
                ...
                <label className="text-[#7030dfdb] relative translate-x-3.5 -translate-y-13.5 z-10 w-fit pl-1 text-sm pr-10 bg-white" htmlFor="password">Password</label>
